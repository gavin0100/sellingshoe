...
//    Account authenticate(@Param("accountName") String accountName, @Param("password") String password);
//
...
//    List<Account> activeAccounts(@Param("status") int status);
//
//    @Query("select a from Account a where a.roleNumber = :role")
//    List<Account> userAccounts(@Param("role") int role);
//
